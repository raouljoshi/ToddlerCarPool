  ...
  return (
    <section className="landing">
      ...
      >
        ...
        <button type="submit" className="accent" disabled={!joinCode || loading}>
          {t.joinRoomCta}
        </button>
      </form>

      <button type="button" className="link-button" onClick={onStartCreate} disabled={loading}>
        {t.orCreateRoom}
      </button>
    </section>
  );
