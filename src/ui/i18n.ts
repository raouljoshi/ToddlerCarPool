...
const en = {
  ...
  tripTimingTitle: "Trip timing",
  tripTimeOptional: "Optional time",
  boardTimeArrive: "Arrive",
  boardTimeLeave: "Leave",
...
const sv: Translation = {
  ...
  tripTimingTitle: "Restider",
  tripTimeOptional: "Valfri tid",
  boardTimeArrive: "Framme",
  boardTimeLeave: "Avresa",
  ...
  boardTapSeat: "Tryck på grön plats.",
